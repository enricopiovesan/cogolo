...
agent_manifest="examples/capabilities/expedition-intent-agent/manifest.json"
agent_request="examples/capabilities/runtime-requests/interpret-expedition-intent.json"

bash examples/capabilities/expedition-intent-agent/build-fixture.sh >/tmp/traverse-agent-build.out
