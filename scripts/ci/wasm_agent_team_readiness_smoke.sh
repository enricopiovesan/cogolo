...
agent_dir="$repo_root/examples/capabilities/team-readiness-agent"
manifest_path="$agent_dir/manifest.json"
request_path="$repo_root/examples/capabilities/runtime-requests/validate-team-readiness.json"
