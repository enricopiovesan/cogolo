...
require_match "$out" "version: 1.1.0" "version"
...
require_match "$out" "capability_version: 1.1.0" "capability_version"
assert_execute() {
...
echo "OK: core.calculate-price 1.1.0 E2E smoke passed"
