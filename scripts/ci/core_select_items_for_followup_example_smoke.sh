...
assert_execute "$pkg/runtime-requests/uc01-quiet-hours.json" "UC-01" '"reason": "quiet_hours"'
assert_execute "$pkg/runtime-requests/uc01-quiet-hours.json" "UC-01 selected empty" '"selected": \[\]'
assert_execute "$pkg/runtime-requests/uc02-escalate.json" "UC-02" '"intensity": "escalate"'
assert_execute "$pkg/runtime-requests/uc02-escalate.json" "UC-02 channel" '"recommended_channel": "manager"'

echo "OK: core.select-items-for-followup 1.1.0 E2E smoke passed"
