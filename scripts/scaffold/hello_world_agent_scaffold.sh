...
3) Inspect and execute via Traverse CLI:
   cargo run -p traverse-cli-rs -- capability-package inspect ${dest_dir}/manifest.json
   cargo run -p traverse-cli-rs -- capability-package execute ${dest_dir}/manifest.json examples/hello-world/runtime-requests/say-hello.json
