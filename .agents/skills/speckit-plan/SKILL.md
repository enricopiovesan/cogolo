...
1. **Claim ticket**: If the user input includes a GitHub issue number, run the `claim-ticket` skill first. If the issue is already claimed by another agent, stop and report — do not proceed with planning.
